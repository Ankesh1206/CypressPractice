...
describe('Create User by post request', () => {
    ...
    it.only('Create User by post request', () => {
        ...
        for (var i = 0; i < 10; i++) {
            ...
            cy.request({
                ...
                body: {
                        ...
                        "name":"AnkeshAutomation Cypress Labs",
                        "gender":"male",
                        "email":testEmail,
                        "status":"active"
                ...
                expect(response.body.data).has.property('name', 'AnkeshAutomation Cypress Labs')
